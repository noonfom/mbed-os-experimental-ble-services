...
# Clone mbed-os
if [ -d "tests/UNITTESTS/mbed-os" ]
then
    echo "Using existing mbed-os"
else
    # git clone https://github.com/ARMmbed/mbed-os.git
    # Use feature-bluetooth-unit-test branch until merged to master
    git clone --depth 1 https://github.com/ARMmbed/mbed-os.git -b feature-bluetooth-unit-test tests/UNITTESTS/mbed-os
fi

# Add symlinks
symlink tests/UNITTESTS/mbed-os tests/TESTS/LinkLoss/device/mbed-os
...
pip install -r tests/UNITTESTS/mbed-os/requirements.txt
